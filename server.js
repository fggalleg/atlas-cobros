...
app.post('/api/send-email', async (req, res) => {
  ...
  const html = '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #333;">'
    ...
    + '<div style="background-color: #f5f5f5; padding: 15px; border-radius: 5px; margin: 25px 0; border-left: 4px solid #1a1a2e;">'
    + '<p style="margin: 0 0 8px 0;"><strong>&iquest;Tienes dudas?</strong></p>'
    + '<p style="margin: 0 0 8px 0; font-size: 14px;">Este correo es automatico y <strong>no recibe respuestas</strong>. Para cualquier consulta, contactame directamente:</p>'
    + '<p style="margin: 0; font-size: 14px;"><strong>Felipe Galleguillos</strong> &mdash; Gerente de Operaciones</p>'
    + '<p style="margin: 4px 0 0 0; font-size: 14px;">WhatsApp / Telefono: <a href="https://wa.me/56973733653" style="color: #1a1a2e;">+56 9 7373 3653</a></p>'
    + '</div>'
    ...
    + '<p>Este es un correo automatico, por favor no respondas a este mensaje. Para dudas, escribe a Felipe Galleguillos al +56 9 7373 3653.</p>'
    + '</div>'
    + '</div>';
